...
<s:form action="currentMovieInfo3">
...
<table><tr>
		...
		list="movies" 
		name="selectedmovie" /></tr></table>
</td>
<td><table><tr><s:textfield name="time" label="Time"/></tr></table></td>
<td><table><tr><s:hidden name="showid"  /></tr></table>
</td>
<td><table><tr>
		<s:select label="Rate Type" 
		headerKey="-1" headerValue="Select Type"
		list="rates" 
		name="ratetype" /></tr></table>
</td>
</tr>
<s:submit name="update" value="Modify" align="center" cssClass="submit"/>
