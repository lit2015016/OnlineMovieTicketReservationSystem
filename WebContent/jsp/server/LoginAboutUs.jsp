...
<div id="container">
 ...
 <div id="header">
    <div id="header_left">
      ...
      <div id="site_title"><span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="Login.jsp">Cinemax</a></span></div>
   </div>
  ...
  <div id="menu">
    ...
    <div id="menu_middle">
      <ul>
        <li><a href="/CINEMAX/jsp/server/Login.jsp"><span>Home</span></a></li>
        
        <li><a href="/CINEMAX/jsp/server/LoginAboutUs.jsp" class="current">About Us</a></li>
  ...
  <h2>Our <span>Team</span></h2></div>
    ...
    <div id="right_column">
      <div class="section2">
        ...
        <s:form action="ServerActionValidate" >
      ...
      <div class="section2">
        ...
        <a href="/CINEMAX/jsp/server/LoginAboutUs.jsp">Contact Us</a><br />
      </div>
